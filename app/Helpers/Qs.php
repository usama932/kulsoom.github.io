...
class Qs
{
    ...
    {
        return self::getSetting('system_title') ?: 'SOUTH WELL';
    }
 ...
 <div class="alert alert-success alert-bordered">
    ...
    public static function getLibrarianTeam()
    {
        return ['admin', 'super_admin','librarian','student'];
    }
    ...
    public static function userIsLibrarian(){
        return in_array(Auth::user()->user_type, self::getLibrarianTeam());
    }
